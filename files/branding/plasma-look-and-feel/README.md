...
1. contents/layouts/org.kde.plasma.desktop-layout.js
   - Configures a Windows-like bottom panel:
     ...
     * Task Manager with icons-only running applications
     * System tray at bottom-right (Network, Volume, Battery, Notifications, Clock)
2. contents/defaults
   - Default color schemes (e.g. BreezeDark / Windows 11 style)
   - Default icon theme
   - Default cursor and window decorations
3. metadata.json
